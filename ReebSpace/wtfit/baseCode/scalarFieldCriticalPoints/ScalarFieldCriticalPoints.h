/// \ingroup baseCode
/// \class wtfit::ScalarFieldCriticalPoints 
/// \author Julien Tierny <julien.tierny@lip6.fr>
/// \date June 2015.
///
/// \brief %ScalarFieldCriticalPoints processing package.
///
/// %ScalarFieldCriticalPoints is a processing package that takes a scalar field on the input and 
/// produces a scalar field on the output.
  ...
  template <class dataType> class ScalarFieldCriticalPoints : public Debug{
    ...
    public:
      ...
      char getCriticalType(const int &vertexId) const{
        ...
        return getCriticalType(vertexId, (*vertexLinkEdgeLists_)[vertexId]);
      }
